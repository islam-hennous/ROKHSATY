                ...
                <div class="col-12 col-lg-9">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="single-blog-content">
                                    ...
                                    <h4><a href="{{ route('client.blog-single') }}" class="post-headline">Party people in
                                            the house</a></h4>
                    ...
                    <div class="single-blog-area blog-style-2 mb-50 wow fadeInUp" data-wow-delay="0.5s"
                        ...
                        <div class="row align-items-center">
                            <div class="col-12 col-md-6">
                                <div class="single-blog-thumbnail">
                                    <img src="{{ asset('client/img/blog-img/5.jpg') }}" alt="">
                                    <div class="post-date">
                                        <a href="#">12 <span>march</span></a>
                                    </div>
                                </div>
                    ...
                    <div class="single-blog-area blog-style-2 mb-50 wow fadeInUp" data-wow-delay="0.6s"
                        ...
                        <div class="row align-items-center">
                            <div class="col-12 col-md-6">
                                <div class="single-blog-thumbnail">
                                    <img src="{{ asset('client/img/blog-img/6.jpg') }}" alt="">
                                    <div class="post-date">
                                        <a href="#">12 <span>march</span></a>
                                    </div>
                                </div>
                ...
                <div class="col-12 col-md-4 col-lg-3">
                    <div class="post-sidebar-area">
                        ...
                        <div class="sidebar-widget-area">
                            <h5 class="title text-right"> رخصتي </h5>
